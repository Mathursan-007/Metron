...
<div class="wrapper">
<button class="pulse" id="myBtn1"><i class="fa fa-plus"></i></button>
</div>
<!-- The Modal -->
...
<form action="./AddGym" method="post" >
  ...
  <h2>ADD GYM</h2>
      ...
      <input type="text" class="form-control" id="paymentID" placeholder="PackageID" name="id" pattern="[G]{1}[0-9]{1}[0-9]{1}[0-9]{1}" required>
      <br><br><br>
