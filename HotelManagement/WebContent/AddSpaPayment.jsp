...
<%SpaReservation pn =(SpaReservation)request.getAttribute("pn");%>
			                   ...
			                   <div class="card-header">
			                    <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
									...
									<ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
									 ...
									 <li class="nav-item"> <a data-toggle="pill" href="#paypal" class="nav-link "> <i class="fas fa-credit-card mr-2"></i>Cash </a> </li>
			                       </ul>
			                   </div> <!-- End -->
			...
			<form role="form" action="./AddSPayment" method="post">
			<div class="form-group"> <label for="username"><h6>Card Owner</h6></label>
			<input type="text"name="username"placeholder="Card Owner Name" value="<%=pn.getCusName()%>"   required class="form-control ">
			</div>
			<div class="form-group"> <label for="username"><h6>Reservation ID</h6></label>
			<input type="text" name="id" placeholder="ID" value="<%=pn.getRID()%>" required class="form-control ">
			</div>
			<div class="form-group"> <label for="username"><h6>Package Name</h6></label>
			<input type="text" name="pname" id="pname" onchange="view();"   value="<%=pn.getGpackagename()%>" required class="form-control ">
			</div>
			<div class="form-group"> <label for="username"><h6>Amount</h6></label>
			<input type="text" name="amount" id="amount" placeholder="00" value="<%=pn.getAmount()%>" required class="form-control ">
			</div>
			...
			<form  action="./AddSPayment" method="post">
			<div class="form-group"> 
			<label for="username"><h6>Customer Name</h6></label> 
			<input type="text"name="username" placeholder=" Name" value="<%=pn.getCusName()%>" required class="form-control ">
			</div>
			<div class="form-group"> <label for="username"><h6>Reservation ID</h6></label>
			<input type="text" name="id" placeholder="ID" value="<%=pn.getRID()%>" required class="form-control ">
			</div>
