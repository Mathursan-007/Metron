				...
				<div class="page-breadcrumb">
					<div class="row">
						<div class="col-10">
							<div class="card">
								<div class="card-body">
							<% Package packages=(Package)request.getAttribute("packages"); %>
								<form  name="AddPackage "action="./UpdatePackage" method="post">
									...
									<br>
										...
										<div class="col-md-6 mb-3">
												...
												<input type="number" class="form-control"
													placeholder=""  name="id" value="<%=(String)packages.getId() %>" required>
											</div>
										 ...
										 <div class="col-md-6 mb-3">
												...
												<input type="text" class="form-control" 
													placeholder="" value="<%=(String)packages.getPackageName() %>" name="packageName" required>
											</div>
											</div>
											<div class="form-row">
											<div class="col-md-6 mb-3">
												...
												<input type="number" class="form-control"
													placeholder=""  name="price" value="<%=packages.getPrice() %>" required>
											</div>
										
										    <div class="col-md-6 mb-3">
												<label>Description</label>
												<input type="text" class="form-control" 
													placeholder="" value="<%=(String)packages.getDescription() %>" name="description" required>
