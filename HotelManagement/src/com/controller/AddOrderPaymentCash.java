...
/**
 * Servlet implementation class AddOrderPaymentCash
 */
@WebServlet("/AddOrderPaymentCash")
public class AddOrderPaymentCash extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddOrderPaymentCash() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Item item:Items) {
		 ...
		 if(restaurantImpl.checkOrderStatus(id)==true){
			...
			restaurantImpl.addOrderPayment(id,amount,"Cash");
